...
\cvevent{Engineering intern}{OKKO}{Online cinema}{2014, summer}{}
\begin{itemize}
...
\cvevent{Physics Teacher}{Formula de Integro}{multidisciplinary summer camp}{2015, summer; 2016, winter}{}
\begin{itemize}
...
\cvevent{Engineering intern}{Papeeria}{Online \LaTeX~editor}{2017, summer}{}
\begin{itemize}
\item Adding UI for working with git merge conflicts
\end{itemize}
...
\cvevent{Online course "Programming basics for Linux"}{Stepik}{educational platform}{2016}{}
\begin{itemize}
...
\cvevent{Leadership and development}{Vozhatnik}{the biggest community of camp tutors in VKontakte}{2016 -- ongoing}{}
\begin{itemize}
...
\cvsection[pagesidebar2_EN]{Education}
\cvevent{Master of Science in Physics}{St.Petersburg Polytechnic University}{}{2015 -- 2017}{}
\textit{graduated with honours}\\
\textbf{Department} of space research\\
\textbf{Thesis}: "The influence of heavy helium isotopes on the processes of Big Bang nucleosynthesis"
...
\vspace{0.9em}
\cvevent{Bachelor of Science in Physics}{St.Petersburg Polytechnic University}{}{2011 -- 2015}{}
\textbf{Department} of space research\\
\textbf{Thesis}: "Computer simulation of acceleration of cosmic rays on the fronts of supernova wave"

\vspace{0.2em}

\cvtag{C++} \cvtag{gle} \cvtag{Parallel programming} \cvtag{Python}

\vspace{0.9em}
\cvevent{Software Engineering}{Computer Science Center}{night school, created by Yandex and JetBrains}{2012 -- 2015}{}
