...
\cvevent{intern programmer}{OKKO}{Online cinema}{2014, summer}{}
\begin{itemize}
...
\cvevent{intern programmer}{Papeeria}{Online \LaTeX~editor}{2017, summer}{}
\begin{itemize}
\item Add UI for working with git merge conflicts
\end{itemize}
...
\textit{graduate with excellence}\\
\textbf{Department} of space research\\
\textbf{Thesis}: "The influence of heavy helium isotopes on the processes of primary nucleosynthesis"
