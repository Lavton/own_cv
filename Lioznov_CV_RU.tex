...
\geometry{left=1cm,right=8cm,marginparwidth=6.8cm,marginparsep=0.5cm,top=0.9cm,bottom=1.25cm}
...
\addbibresource{lioznov_pub.bib}
...
\cvevent{Программист-стажёр}{OKKO}{онлайн-кинотеатр}{лето 2014}{}
\begin{itemize}
...
\cvevent{Преподаватель физики}{Формула Единства}{многопрофильный детский лагерь}{лето 2015, зима 2016}{}
\begin{itemize}
...
\cvevent{Программист-стажёр}{Papeeria}{онлайн \LaTeX~редактор}{Лето 2017}{}
\begin{itemize}
\item Добавил UI для работы с git при конфликтах
\end{itemize}
\cvtag{Java} \cvtag{Coffeescript} \cvtag{Docker} \cvtag{LESS}
...
\cvevent{Онлайн-курс "Основы программирования для Linux"}{Stepik}{образовательная платформа}{2016}{}
\begin{itemize}
...
\cvevent{Руководство и разработка}{Вожатник}{крупнейшее сообщество для вожатых ВК}{2016 -- н/в}{}
\begin{itemize}
...
\cvsection[pagesidebar2_RU]{Образование}
\cvevent{Магистр физики}{Политехнический университет}{}{2015 -- 2017}{}
\textit{С красным дипломом}\\
\textbf{Кафедра:} Космических Исследований\\
\textbf{Тема диссертации:} "Влияние тяжёлых изотопов гелия на процессы первичного нуклеосинтеза"

\vspace{0.2em}

\cvtag{Python} \cvtag{scipy} 

\vspace{0.9em}
\cvevent{Бакалавр физики}{Политехнический университет}{}{2011 -- 2015}{}
\textbf{Кафедра:} Космических Исследований\\
\textbf{Тема диссертации:} "Компьютерное моделирование ускорения космических лучей на фронтах волны сверхновой"

\vspace{0.2em}

\cvtag{C++} \cvtag{gle} \cvtag{Параллельное программирование} \cvtag{Python}

\vspace{0.9em}
\cvevent{Разработчик ПО}{Computer Science Center}{вечерние курсы, созданные по инициативе Yandex и JetBrains}{2012 -- 2015}{}
...
\printbibliography[heading=pubtype,title={\printinfo{\faGroup}{Участие в конференциях}},type=inproceedings]
